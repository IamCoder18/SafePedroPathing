...
public class DriveEncoderLocalizer implements Localizer {
    ...
    /**
     * This creates a new DriveEncoderLocalizer from a SafeHardwareMap, with a starting Pose at (0,0)
     * facing 0 heading.
     *
     * @param safeMap the SafeHardwareMap
     */
    public DriveEncoderLocalizer(SafeHardwareMap safeMap, DriveEncoderConstants constants) {
        this(safeMap, constants, new Pose());
    }

    /**
     * This creates a new DriveEncoderLocalizer from a SafeHardwareMap and a Pose, with the Pose
     * specifying the starting pose of the localizer.
     *
     * @param safeMap      the SafeHardwareMap
     * @param setStartPose the Pose to start from
     */
    public DriveEncoderLocalizer(SafeHardwareMap safeMap, DriveEncoderConstants constants, Pose setStartPose) {
        ...
        leftFront = new Encoder(safeMap.device(DcMotorEx.class, constants.leftFrontMotorName));
        leftRear = new Encoder(safeMap.device(DcMotorEx.class, constants.leftRearMotorName));
        rightRear = new Encoder(safeMap.device(DcMotorEx.class, constants.rightRearMotorName));
        rightFront = new Encoder(safeMap.device(DcMotorEx.class, constants.rightFrontMotorName));
