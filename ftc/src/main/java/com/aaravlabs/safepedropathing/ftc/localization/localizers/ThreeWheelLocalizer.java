...
public class ThreeWheelLocalizer implements Localizer {
    ...
    /**
     * This creates a new ThreeWheelLocalizer from a SafeHardwareMap, with a starting Pose at (0,0)
     * facing 0 heading.
     *
     * @param safeMap the SafeHardwareMap
     */
    public ThreeWheelLocalizer(SafeHardwareMap safeMap, ThreeWheelConstants constants) {
        this(safeMap,constants, new Pose());
    }

    /**
     * This creates a new ThreeWheelLocalizer from a SafeHardwareMap and a Pose, with the Pose
     * specifying the starting pose of the localizer.
     *
     * @param safeMap      the SafeHardwareMap
     * @param setStartPose the Pose to start from
     */
    public ThreeWheelLocalizer(SafeHardwareMap safeMap, ThreeWheelConstants constants, Pose setStartPose) {
