...
public class TwoWheelLocalizer implements Localizer {
    ...
    /**
     * This creates a new TwoWheelLocalizer from a SafeHardwareMap, with a starting Pose at (0,0)
     * facing 0 heading.
     *
     * @param safeMap the SafeHardwareMap
     */
    public TwoWheelLocalizer(SafeHardwareMap safeMap, TwoWheelConstants constants) {
        this(safeMap, constants, new Pose());
    }

    /**
     * This creates a new TwoWheelLocalizer from a SafeHardwareMap and a Pose, with the Pose
     * specifying the starting pose of the localizer.
     *
     * @param safeMap      the SafeHardwareMap
     * @param setStartPose the Pose to start from
     */
    public TwoWheelLocalizer(SafeHardwareMap safeMap, TwoWheelConstants constants, Pose setStartPose) {
        ...
        forwardEncoder = new Encoder(safeMap.device(DcMotorEx.class, constants.forwardEncoder_HardwareMapName));
