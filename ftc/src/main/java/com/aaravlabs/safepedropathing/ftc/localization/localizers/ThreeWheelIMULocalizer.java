...
import com.aaravlabs.safepedropathing.ftc.localization.CustomIMU;
import com.aaravlabs.safepedropathing.ftc.localization.constants.ThreeWheelIMUConstants;
import com.qualcomm.robotcore.hardware.DcMotorEx;

import org.firstinspires.ftc.robotcore.external.navigation.AngleUnit;

import com.aaravlabs.safepedropathing.ftc.localization.Encoder;
...
public class ThreeWheelIMULocalizer implements Localizer {
    ...
    /**
     * This creates a new ThreeWheelIMULocalizer from a SafeHardwareMap, with a starting Pose at (0,0)
     * facing 0 heading.
     *
     * @param safeMap the SafeHardwareMap
     */
    public ThreeWheelIMULocalizer(SafeHardwareMap safeMap, ThreeWheelIMUConstants constants) {
        this(safeMap, constants, new Pose());
    }

    /**
     * This creates a new ThreeWheelIMULocalizer from a SafeHardwareMap and a Pose, with the Pose
     * specifying the starting pose of the localizer.
     *
     * @param safeMap      the SafeHardwareMap
     * @param setStartPose the Pose to start from
     */
    public ThreeWheelIMULocalizer(SafeHardwareMap safeMap, ThreeWheelIMUConstants constants, Pose setStartPose) {
        ...
        imu.initialize(safeMap, constants.IMU_HardwareMapName, constants.IMU_Orientation);

        leftEncoder = new Encoder(safeMap.device(DcMotorEx.class, constants.leftEncoder_HardwareMapName));
        rightEncoder = new Encoder(safeMap.device(DcMotorEx.class, constants.rightEncoder_HardwareMapName));
        strafeEncoder = new Encoder(safeMap.device(DcMotorEx.class, constants.strafeEncoder_HardwareMapName));
