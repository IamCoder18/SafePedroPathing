...
import com.aaravlabs.safepedropathing.control.PIDFController;
...
public class CoaxialPod implements SwervePod {
     ...
     */
    public CoaxialPod(SafeHardwareMap safeMap, String motorName, String servoName,
        ...
        this.driveMotor = safeMap.device(DcMotorEx.class, motorName);
        this.turnServo = safeMap.device(CRServo.class, servoName);
        this.turnEncoder = safeMap.device(AnalogInput.class, turnEncoderName);
        ...
        driveMotor.run(m -> m.setDirection(driveDirection));
        turnServo.run(s -> s.setDirection(servoDirection));
    ...
    public String debugString() {
        ...
        try {
            ...
            drivePower = driveMotor.call(DcMotorEx::getPower);
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
