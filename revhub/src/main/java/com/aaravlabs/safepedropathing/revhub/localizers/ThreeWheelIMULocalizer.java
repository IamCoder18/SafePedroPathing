...
import com.aaravlabs.safepedropathing.utils.Timer;
...
public class ThreeWheelIMULocalizer implements Localizer {
    ...
    public ThreeWheelIMULocalizer(SafeHardwareMap map, ThreeWheelIMUConfig config) {
        ...
        this.leftEncoder = new Encoder(map.device(DcMotorEx.class, config.leftEncoderName.get()));
        this.rightEncoder = new Encoder(map.device(DcMotorEx.class, config.rightEncoderName.get()));
        this.strafeEncoder = new Encoder(map.device(DcMotorEx.class, config.strafeEncoderName.get()));
