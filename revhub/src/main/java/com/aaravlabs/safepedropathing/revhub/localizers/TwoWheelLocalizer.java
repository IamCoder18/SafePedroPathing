...
public class TwoWheelLocalizer implements Localizer {
    ...
    public TwoWheelLocalizer(SafeHardwareMap map, TwoWheelConfig config) {
        ...
        this.xPodEncoder = new Encoder(map.device(DcMotorEx.class, config.xPodName.get()));
        this.yPodEncoder = new Encoder(map.device(DcMotorEx.class, config.yPodName.get()));
